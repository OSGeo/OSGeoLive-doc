...
Lubuntu ベースの Mac および Windows へのインストーラを含んだブータブル DVD です。8 GBの ブータブル USB ドライブとしても使用できます。ダウンロードしたファイルの md5 チェックサムをご確認ください。  `(osgeo-live-8.0.iso.md5) <http://download.osgeo.org/livedvd/release/8.0/osgeo-live-8.0.iso.md5/download>`_.
...
Windows および Mac 用のインストーラーを含んでいない点のみ osgeo-live-8.0.iso と異なります。4 GB のブータブル USB ドライブとしても使用できます。ダウンロードしたファイルの md5 チェックサムをご確認ください。 `(osgeo-live-mini-8.0.iso.md5) <http://download.osgeo.org/livedvd/release/8.0/osgeo-live-mini-8.0.iso.md5/download>`_.
...
あらかじめ `7-Zip <http://www.7-zip.org/>`_ で圧縮したVirtualBox、VMWare、KVM などの仮想マシン用の仮想ディスク(.vmdk)です。Windows、 Mac 用のインストーラーは含みません。ダウンロードしたファイルの md5 チェックサムをご確認ください。 `(osgeo-live-vm-8.0.7z.md5) <http://download.osgeo.org/livedvd/release/8.0/osgeo-live-vm-8.0.7z.md5/download>`_.
