...
Wenn Sie Beispieldaten in Ushahidi eingegeben haben, dann können Sie diese Informationen in Sahana Eden über `folgenden Link <http://127.0.0.1:8007/eden/irs/ireport/ushahidi>`_ abrufen.

Sie finden Sahana Eden bereits so konfiguriert, dass Sie auf die Kartendaten und Map-Server zugreifen können, die Teil von OSGeo-Live sind. Sahana Eden kann OpenStreetMap als Basiskarten-Layer im `Map Viewing Client <http://127.0.0.1:8007/eden/gis/map_viewing_client>`_ nutzen. Sahana Eden unterstützt eine breite Palette von OpenStreetMap Diensten.
