...
.. figure:: /images/screenshots/geonetwork/geonetwork_home-page.png
  :scale: 70 %
...
.. figure:: /images/screenshots/geonetwork/geonetwork_signin.png
  :scale: 70 %

Once connected, the top toolbar should provide a link to the ``admin console``
and your login details.

.. figure:: /images/screenshots/geonetwork/geonetwork_identified-user.png
  :scale: 70 %

Go to the ``admin console`` and click on metadata and templates:


.. figure:: /images/screenshots/geonetwork/geonetwork_metadata-and-templates.png
  :scale: 70 %

Choose all standards and click ``load samples`` and then ``load templates`` in
order to load examples:

.. figure:: /images/screenshots/geonetwork/geonetwork_templates.png
  :scale: 70 %

Go back to the search page to see examples:

.. figure:: /images/screenshots/geonetwork/geonetwork_once-samples-are-loaded.png
  :scale: 70 %
...
.. figure:: /images/screenshots/geonetwork/geonetwork_full-text.png
  :scale: 70 %

* facets which defines groups that you can easily click on to browse the content of the catalog

.. figure:: /images/screenshots/geonetwork/geonetwork_facets.png
  :scale: 70 %

* spatial filtering to choose information in specific areas

.. figure:: /images/screenshots/geonetwork/geonetwork_spatial-filter.png
  :scale: 70 %

* advanced search

.. figure:: /images/screenshots/geonetwork/geonetwork_advanced.png
  :scale: 70 %
...
.. figure:: /images/screenshots/geonetwork/geonetwork_a-result.png
  :scale: 70 %
...
.. figure:: /images/screenshots/geonetwork/geonetwork_a-record.png
  :scale: 70 %
...
.. figure:: /images/screenshots/geonetwork/geonetwork_map-africa-basin.png
  :scale: 70 %
