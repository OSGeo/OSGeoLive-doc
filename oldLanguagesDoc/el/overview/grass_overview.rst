...
Το πρόγραμμα GRASS περιλαμβάνει περισσότερες από 400 μονάδες λογισμικού ανάλυσης. Επιπροσθέτως, πάνω από 100 εφαρμογές και εργαλειοθήκες παρέχονται από την κοινότητα χωρίς κόστος από το wiki της κοινότητας. Μετά από 30 χρόνια συνεχούς ανάπτυξης, το λογισμικό GRASS είναι ταυτόχρονα το παλαιότερο και μεγαλύτερο διαθέσιμο Γεωγραφικό Σύστημα Πληροφοριών Ανοιχτού Κώδικα. Είναι εύκολα επεκτάσιμο και ευέλικτο για χρήση τόσο σε μαζικές διαδικασίες επεξεργασίας όσο και σε περιβάλλον παράλληλης εκτέλεσης σε υπερυπολογιστές καθώς επίσης και σε χρήση από προσωπικό υπολογιστή ή υπολογιστή χειρός.
...
* Μπορείτε να δείτε την `συλλογή εικόνων <http://grass.osgeo.org/projects/>`_.
...
**Υποστήριξη:** http://grass.osgeo.org/support/
