...
* RAM: τουλάχιστον 2GB. Η διανομή Lubuntu εκτελείται ικανοποιητικά με 1GB μνήμης RAM, ενώ χρειάζεστε άλλο τόσο περίπου για το σύστημα που φιλοξενεί την εικονική μηχανή σας. Έτσι είναι βέβαιο ότι με 2GB θα έχετε ομαλή λειτουργία.
