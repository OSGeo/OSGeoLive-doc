...
Ένα υποσύνολο χαρακτηριστικών μπορεί να αναγνωριστεί και να οπτικοποιηθεί με συγκεκριμένο χρώμα ή να μετατραπεί σε συγκεκριμένο ψηφιακό πρότυπο που επιλέγει ο χρήστης. Μια γενικευμένη κωδικοποίηση φίλτρων XML επιτρέπει την εύκολη ανάγνωση και επικαιροποίηση από έναν εξυπηρετητή που υλοποιεί το πρότυπο WFS πρωτού η έκφραση του φίλτρου μετατραπεί στην εγγενή γλώσσα της βάσης δεδομένων στην οποία είναι αποθηκευμένα τα δεδομένα και η οποία καλείται να απαντήσει στο ερώτημα. Αυτό το πρότυπο χρησιμοποιείται από ένα πλήθος διαδικτυακών υπηρεσιών του OGC, περιλαμβανομένου του WFS, της υπηρεσίας καταλόγου (CSW) και του προτύπου SLD.
