...
================================================================================  =================================================================
================================================================================  =================================================================
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomin.png                 Увеличить: либо щёлкните в нужную область, либо нарисуйте охватывающий прямоугольник. Увеличение и уменьшение также может быть сделано с помощью колеса прокрутки мыши.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomout.png                Уменьшить.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomfullextent.png         Масштабировать до охвата всех видимых слоёв.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomselected.png           Масштабировать для выбранных объектов целевого слоя.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomprevious.png           Перейти к списку предыдущих видов карты (охватов).
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomnext.png               Перейти к списку последующих видов карты (охватов).
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-zoomlayer.png              Перейти к охвату целевого слоя.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-pan.png                    Щёлкните и перетащите карту.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-select.png                 Выбор объектов целевого слоя. Для выбора нескольких объектов удерживайте клавишу Ctrl или нарисуйте охватывающий прямоугольник. См. раздел 4.2 для получения дополнительной информации по выборкам.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-measure.png                Открывает диалог для отображения информации о периметре и площади выбранных объектов из целевого слоя, или объектов, нарисованных при помощи мыши.
.. image:: /images/screenshots/mapwindow/mapwindow-toolbar-identify.png               Нажмите для просмотра атрибутов объектов целевого слоя.
================================================================================  =================================================================
...
.. image:: /images/screenshots/mapwindow/mapwindow-categories.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-button-plus.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-category-generation.png
  :alt: Создание категорий
  :align: right
  :width: 502
  :height: 573
...
.. image:: /images/screenshots/mapwindow/mapwindow-shapefile-categories.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-legend.png
...
-------------------------------------------
.. image:: /images/screenshots/mapwindow/mapwindow-coloringscheme-editor.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-label-expression.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-labelmover.png   
...
.. image:: /images/screenshots/mapwindow/mapwindow-symbology.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-button-more.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-export.png
  :alt: Экспорт карты
  :align: right
  :width: 406 
  :height: 260
...
.. image:: /images/screenshots/mapwindow/mapwindow-table.png
  :alt: Редактор таблиц
  :align: right
  :width: 58 
  :height: 50
...
4.2 Выборки
----------------
.. image:: /images/screenshots/mapwindow/mapwindow-select.png
  :alt: Выборка
  :align: right
  :width: 89 
  :height: 55
...
.. image:: /images/screenshots/mapwindow/mapwindow-query.png
  :alt: Запрос
  :align: right
  :width: 65 
  :height: 52
...
+++++++++++++++++++++++++++++++++
.. image:: /images/screenshots/mapwindow/mapwindow-querybuilder.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-table-editor.png
  :alt: Table editor
  :align: right
  :width: 26 
  :height: 23
...
.. image:: /images/screenshots/mapwindow/mapwindow-toolbox.png
...
.. image:: /images/screenshots/mapwindow/mapwindow-coordinates.png
  :alt: Координаты
  :align: right
  :width: 285 
  :height: 47
