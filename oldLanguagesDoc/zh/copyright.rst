...
* 项目简介和各分项简介文档在 `Creative Commons Attribution 3.0 Unported License <https://creativecommons.org/licenses/by/3.0/>`_ 下发布。
* 各入门教程（快速开始）及其翻译在 `Creative Commons Attribution-ShareAlike 3.0 Unported License <https://creativecommons.org/licenses/by-sa/3.0/>`_ 下发布。
* 某些文档可能以其它协议发布，详见后述。
