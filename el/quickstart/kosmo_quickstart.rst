...
#. Αρχίστε το GeoServer WMS που συμπεριλαμβάνετε στο OSGeo-Live DVD επιλέγοντας την επιλογή |osgeolive-appmenupath-geoserver| (ή από τον υπολογιστή, πηγαίνετε στο φάκελο *Web Services* και κάντε διπλό κλικ στο εικονίδιο εκκίνησης Geoserver)
