...
.. image:: ../images/download_buttons/download-dvd.png
  ...
  :align: left
  :target: http://download.osgeo.org/livedvd/release/6.0/osgeolive-6.0.iso

`osgeo-live-6.0.iso <http://download.osgeo.org/livedvd/release/6.0/osgeolive-6.0.iso>`_ : |osgeolive-iso-size|

Ένα DVD αυτόματης εκκίνησης βασισμένο στην διανομή Xubuntu, το οποίο περιλαμβάνει αρχεία για τα λειτουργικά Windows και Mac. Μπορεί επιπλέον να αντιγραφεί σε USB αυτόματης εκκίνησης μεγέθους 8 GB. Επιβεβαιώστε το κατεβασμένο αρχείο σας με το md5sum checksum `(osgeo-live-6.0.iso.md5) <http://download.osgeo.org/livedvd/release/6.0/osgeolive-6.0.iso.md5>`_.

.. image:: ../images/download_buttons/download-mini.png
  :alt: Κατεβάστε το αρχείο μεγέθους 3.3 GB χωρίς τα αρχεία για Windows και Mac
  :align: left
  :target: http://download.osgeo.org/livedvd/release/6.0/osgeolive-6.0-mini.iso

`osgeo-live-mini-6.0.iso <http://download.osgeo.org/livedvd/release/6.0/osgeolive-6.0-mini.iso>`_ : |osgeolive-iso-mini-size|
