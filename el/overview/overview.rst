...
* |nologo| :doc:`cartaro_overview` - [:doc:`Γρήγορη Εκκίνηση <../quickstart/cartaro_quickstart>`] - Γεωχωρικό Σύστημα Διαχείρισης Περιεχομένου
...
* |nologo| :doc:`iris_overview` - [:doc:`Γρήγορη Εκκίνηση <../quickstart/iris_quickstart>`] - Μετεωρολογία και Κλιματολογία

Άλλα λογισμικά ενδιαφέροντος (μη εγκατεστημένα άμεσα)
--------------------------------------------------------------------------------
* |nologo| :doc:`mapguide_overview` - [:doc:`Γρήγορη Εκκίνηση <../quickstart/mapguide_quickstart>`] - Διαδικτυακή Υπηρεσία
...
* :doc:`Στατιστικά Λογισμικών <../metrics>` από το Ohloh
