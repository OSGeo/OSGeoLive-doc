...
**Υπηρεσία διαδικτυακής επεξεργασίας (WPS)**
    Γεωχωρικοί αλγόριθμοι, περιλαμβανομένων αυτών του :doc:`JTS <jts_overview>`_, μπορούν να εκτελεστούν μέσω της υπηρεσίας :doc:`WPS <../standards/wps_overview>`_ του GeoServer. Αυτό περιλαμβάνει την αλυσιδωτή εκτέλεση των επεξεργασιών και στη συνέχεια την οπτικοποίηση μέσω της υπηρεσίας WMS.
