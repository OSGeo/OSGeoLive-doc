...
Wskaźniki tworzone przez `Ohloh <https://www.ohloh.net/>`_ na podstawie repozytoriów kodu źródłowego projektów. Mają one nieznaczne różnice od stanu faktycznego (spowodowane na przykład przenoszeniem repozytoriów), i dostarczają jedynie częściowej informacji na temat stanu projektu.
