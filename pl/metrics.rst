...
Wskaźniki tworzone przez `OpenHUB <https://www.openhub.net/>`_ na podstawie repozytoriów kodu źródłowego projektów. Mają one nieznaczne różnice od stanu faktycznego (spowodowane na przykład przenoszeniem repozytoriów), i dostarczają jedynie częściowej informacji na temat stanu projektu.
...
Desktop GIS
--------------------------------------------------------------------------------
GIS ogólnego zastosowania - przeglądanie, edycja, analizy na komputerze:
...
--------------------------------------------------------------------------------
GIS ogólnego zastosowania - przeglądanie, edycja, analizy w przeglądarce internetowej:
...
.. raw:: html
  ...
  <script type="text/javascript" src="http://www.openhub.net/p/gosmore/widgets/project_factoids_stats.js"></script>

Brakujące:

* `overview/osmarender <http://wiki.openstreetmap.org/wiki/Osmarender>`_

Narzędzia geoprzestrzenne
--------------------------------------------------------------------------------
...
Biblioteki odniesień przestrzennych 
--------------------------------------------------------------------------------
...
Inne programy (nie zawarte w OSGeo-Live)
--------------------------------------------------------------------------------
.. raw:: html
