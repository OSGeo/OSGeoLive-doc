...
这是一个基于 Lubuntu 建立的 DVD 镜像，其中也包含了部分软件在 Windows 或 Mac 下的安装程序。它也可以安装在 8G 的 USB 盘上。下载前请检查文件的 MD5 值 `(osgeo-live-9.0.iso.md5) <http://download.osgeo.org/livedvd/release/9.0/osgeo-live-9.0-i386.iso.md5/download>`_ 。
...
这个版本除了不包含 Windows 及 Mac 安装程序外与前置一样。它可以安装在 4G 的 USB 盘中。下载前请检查文件的 MD5 值 `(osgeo-live-mini-9.0.iso.md5) <http://download.osgeo.org/livedvd/release/9.0/osgeo-live-mini-9.0-i386.iso.md5/download>`_ 。
...
用 `7-Zip <http://www.7-zip.org/>`_ 压缩好的虚拟盘（.vmdk），使用于 VirtualBox 、VMWare 、KVM 等虚拟机环境。它不包含 Windows 及 Mac 安装程序。下载前请检查文件的 MD5 值 `(osgeo-live-vm-9.0.7z.md5) <http://download.osgeo.org/livedvd/release/9.0/osgeo-live-vm-9.0.7z.md5/download>`_ 。
