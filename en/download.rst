...
Premade virtual disk (.vmdk) suitable for use in VirtualBox, VMWare, KVM and other virtual machine applications. Does not contain windows and mac installers. Verify your download with its `md5sum <http://download.osgeo.org/livedvd/release/4.5/osgeo-live-4.5.7z.md5>`_.
