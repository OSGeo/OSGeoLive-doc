...
An Xubuntu based bootable DVD, which also includes windows and mac installers. It can also be copied to an 8 GB bootable USB thumb drive. Verify your download with its md5sum checksum `(osgeo-live-5.0.iso.md5) <http://download.osgeo.org/livedvd/release/5.0/osgeo-live-5.0.iso.md5>`_.
...
Same as osgeo-live-5.0.iso, except it doesn't contain windows and mac installers and can be copied onto a 4 GB bootable USB thumb drive. Verify your download with its md5sum checksum `(osgeo-live-mini-5.0.iso.md5) <http://download.osgeo.org/livedvd/release/5.0/osgeo-live-mini-5.0.iso.md5>`_.
...
Premade `7-Zip <http://www.7-zip.org/>`_ compressed virtual disk (.vmdk) suitable for use in VirtualBox, VMWare, KVM and other virtual machine applications. Does not contain windows and mac installers. Verify your download with its md5sum checksum `(osgeo-live-vm-5.0.7z.md5) <http://download.osgeo.org/livedvd/release/5.0/osgeo-live-vm-5.0.7z.md5>`_.
