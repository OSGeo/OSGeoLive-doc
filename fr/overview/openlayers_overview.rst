...
OpenLayers permet pour les développeurs web de facilement encapsuler des cartes 
dynamiques, à partir d'une multitude de sources, dans n'importe quelle page web.
OpenLayers fournit une jeu étendu d'outils et de "widgets" cartographiques, 
similaire à l'API Google Maps API. Toutes les fonctionnalités fonctionnent dans 
...
* Support de protocoles standards et customisés pour interagir avec les serveurs
...
* Capacité à parser les données vecteur et les métadonnées dans de nombreux formats:
...
* :doc:`Documentation du guide de démarrage rapide <../quickstart/openlayers_quickstart>`
