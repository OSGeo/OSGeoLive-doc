...
Les métriques fournies par `Ohloh <https://www.ohloh.net/>`_ sont dérivées à partir des dépôts du code du projet. Notez que ces métriques ont connu des déficiences (causées par des changements de dépôts), et fournissent seulement des indications partielles à propos du développement du projet. Un manque de changement dans des paquets plus petits concis et librairies peuvent simplement refléter un niveau de maturité et de complétude. 
...
SIG Bureautique
--------------------------------------------------------------------------------
Affichage SIG général, édition, et analyse sur le bureau :
...
SIG par navigateur
--------------------------------------------------------------------------------
Affichage SIG général, édition, et analyse par le navigateur :
...
Services Web
--------------------------------------------------------------------------------
Publication des données spatiales sur internet :
...
Bases de données
--------------------------------------------------------------------------------
Sauvegarder les données spatiales :
...
SIG Spécifique à un Domaine
--------------------------------------------------------------------------------
Applications ciblées pour un domaine spécifique :
...
* :doc:`overview/mb-system_overview` - Cartographie de Fonds Océaniques
...
Autres logiciels d'intérêt (non disponible dans Live)
--------------------------------------------------------------------------------
.. raw:: html
