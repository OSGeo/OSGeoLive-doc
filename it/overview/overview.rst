...
Gestori di Crisi
--------------------------------------------------------------------------------
* :doc:`sahana_overview` - [:doc:`Guida rapida <../quickstart/sahana_quickstart>`] - Gestione dei disastri
...
* :doc:`saga_overview` - [:doc:`Guida rapida <../quickstart/saga_quickstart>`]
* :doc:`ossim_overview` - [:doc:`Guida rapida <../quickstart/ossim_quickstart>`] - Elaborazione di immagini
* :doc:`geopublisher_overview` - [:doc:`Guida rapida <../quickstart/geopublisher_quickstart>`] - Catalogo
* :doc:`atlasstyler_overview` - [:doc:`Guida rapida <../quickstart/atlasstyler_quickstart>`] - Editor per stili
...
* :doc:`gdal_overview`  - [:doc:`Guida rapida <../quickstart/gdal_quickstart>`] - Strumenti per la conversione di dati geospaziali
...
--------------------------------------------------------------------------------
* :doc:`mapguide_overview` - [:doc:`Guida rapida <../quickstart/mapguide_quickstart>`] - Web Service
