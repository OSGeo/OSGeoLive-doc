...
#for file in 1900-12-21-start-josm 200-12-23-id-editor ; do
for file in 1900-12-21-start-josm 200-12-23-id-editor ; do
  pandoc --from=markdown --to=rst --output=${tmp} {$file}.md

  # Change the location of images
  sed -e's#/images/beginner/#/images/screenshots/1024x768/#g' ${tmp} > ${file}.rst
done
