...
* Обзоры проектов и их переводы предоставляются под лицензией `Creative Commons Attribution 3.0 Unported License <https://creativecommons.org/licenses/by/3.0/>`_.
* Краткие введения и их переводы предоставляются под лицензией `Creative Commons Attribution-ShareAlike 3.0 Unported License <https://creativecommons.org/licenses/by-sa/3.0/>`_.
...
Далее, если включены Введения, которые лицензируются под `CC By-SA <https://creativecommons.org/licenses/by-sa/3.0/>`_, то новый документ также должен будет лицензироваться под `CC By-SA <https://creativecommons.org/licenses/by-sa/3.0/>`_.
...
**Подробный вариант, подходит для 100-страничной работы:**
  ...
  Attribution-ShareAlike 3.0 Unported, https://creativecommons.org/licenses/by-sa/3.0/, доступного в
...
**Сокращённый CC-By-SA и атрибутирование:**
  ...
  © 2011 [Ваше Имя] под `лицензией CC By SA <https://creativecommons.org/licenses/by-sa/3.0/>`_.
