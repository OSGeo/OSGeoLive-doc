...
Windows y Mac. También se puede copiar a una memoria USB de 8GB. Verificar la descarga con su suma de verificación `osgeo-live-8.5.iso.md5 <http://download.osgeo.org/livedvd/release/8.5/osgeo-live-8.5.iso.md5/download>`_.
...
Igual que osgeo-live-8.5.iso, excepto que no contiene instaladores para Windows y Mac y se puede copiar en una memoria USB de arranque de 4GB. Verificar la descarga con su suma de verificación `osgeo-live-mini-8.5.iso.md5 <http://download.osgeo.org/livedvd/release/8.5/osgeo-live-mini-8.5.iso.md5/download>`_.
