...
.. image:: ../images/download_buttons/download-dvd.png
  :alt: Descarga el fichero iso de 4.3GB para USB o DVD
  :align: left
...
`suma MD5 <http://download.osgeo.org/livedvd/release/4.5/osgeolive-4.5.iso.md5>`_.
...
Igual que ``osgeo-live-4.5.iso``, excepto que no contiene instalables para
