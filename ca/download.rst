...
El mateix que osgeo-live-7.0.iso, però no conté instal·ladors per Windows ni per Mac i es pot copiar a un disc USB d'arrancada de 4 GB. Verifiqueu la descàrrega amb la corresponent suma de comprovació `(osgeo-live-mini-7.0.iso.md5) <http://download.osgeo.org/livedvd/release/7.0/osgeo-live-mini-7.0.iso.md5/download>`_.
